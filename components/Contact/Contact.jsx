        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <form ref={form} onSubmit={sendEmail}>
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button type="submit" value="SEND" className="flex mx-auto text-white bg-accent border-0 py-2 px-8 focus:outline-none hover:bg-accent rounded md:text-md">Send me a message</button>
              </div>
            </div>
          </form>
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center text-white">
              <p>{contactData[0].email}</p>
              <p className=" my-5">{contactData[1].address}</p>
