          ...
          <section class="container text-gray-600 body-font mt-4">
            <div class="flex flex-wrap">
                <div class="flex flex-wrap w-1/2">
                  <div class="w-full md:w-1/3 h-40 m-2 p-2 flex flex-col justify-between text-left rounded bg-gray-200">
                    <p>Polycarbonate</p>
                    <p className='border-t-2 border-white text-2xl font-bold'>PC</p>
                  </div>
                  <div class="w-full md:w-1/4 h-24 md:h-40 m-2 p-2  flex flex-col justify-between text-left rounded bg-gray-200  ">
                    <p>Polybutylene terephthalate</p>
                    <p className='border-t-2 border-white text-2xl font-bold'>PBT</p>
                  </div>
                  <div class="w-full h-60 md:h-80 m-2 p-2 flex flex-col justify-between text-left rounded bg-gray-200  ">
                    <p>Polyurethane</p>
                ...
                <div class="flex flex-wrap w-1/2">
                  ...
                  <div class="w-full md:w-1/3 h-30 md:h-40 m-2 p-2  flex flex-col justify-between text-left rounded bg-gray-200  ">
                    <p>Acrylonitrile butadiene styrene</p>
                    <p className='border-t-2 border-white text-2xl font-bold'>ABS</p>
                  </div>
                  <div class="w-full md:w-1/4 h-30 md:h-40 m-2 p-2  flex flex-col justify-between text-left rounded bg-gray-200   ">
            ...
            <div class="flex flex-wrap justify-center mx-auto">
                    <div class="w-1/2 md:w-1/5 md:h-40 m-2 p-2 flex flex-col justify-between text-left rounded bg-gray-200">
                    ...
                    <div class="w-full md:w-1/5 md:h-40 m-2 p-2 flex flex-col justify-between text-left rounded bg-gray-200 ">
