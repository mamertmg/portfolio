...
function Business() {
  return (
    <section id="Services" className="container mx-auto md:h-[800px] py-4 md:py-8">
      <h2 className="h2 text-center md:text-left">How I'll Grow Your Business</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 justify-center items-center py-4 md:py-24 mx-auto ">
        {businessData.map((item) => (
              <div className="transition-all duration-200 hover:shadow-md hover:shadow-accent py-2 my-2 px-4 rounded" key={item.name}>
                  <div>
                      {item.icon}
      ...
      <div className="flex flex-row mx-auto items-center justify-center my-2 md:py-12">
