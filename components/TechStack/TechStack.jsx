...
function TechStack() {
  ...
  return (
    <div id="stack" className='min-h-screen bg-white antialiased text-center'>
        ...
        <div class="container w-full mx-auto justify-center flex flex-wrap md:mt-4">
              {techSrc.map(item =>(
                <div class="h-full flex items-center border-gray-200 border p-2 m-2 md:p-4 md:m-4 rounded-lg">
